<template>
	<svg class="account-toggle-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 298.98 298.98">
		<title>Account Toggle</title>
		<!--<rect class="cls-1" width="298.98" height="298.98"/>-->
		<path class="circle" d="M94.92,189.37l64.9-15.11L178.28,71.87l104,130.66a142.1,142.1,0,1,0-138.54,89.72L75.12,205Z"/>
